    ...
    public static async Task SeedAsync(PortfolioDbContext context, ILogger logger)
    {
        ...
        var projects = new[]
        {
            new Project
            {
                ...
                ImageUrls = new List<string> { "/projects/tax-system-1.png", "/projects/tax-system-2.png", "/projects/tax-system-3.png", "/projects/tax-system-4.png" },
                GitHubUrl = null,
                LiveUrl = null,
            ...
            new Project
            {
                ...
                ImageUrls = new List<string> { "/projects/correspondence-1.png", "/projects/correspondence-2.png", "/projects/correspondence-3.png", "/projects/correspondence-4.png" },
                GitHubUrl = null,
                LiveUrl = null,
            ...
            new Project
            {
                ...
                ImageUrls = new List<string> { "/projects/blazor-website-1.png"},
                GitHubUrl = null,
                LiveUrl = null,
            ...
            new Project
            {
                ...
                ImageUrls = new List<string> { "/projects/wpf-app-1.png" },
                GitHubUrl = null,
                LiveUrl = null,
            ...
            new Project
            {
                ...
                ImageUrls = new List<string> { "/projects/portfolio-1.png" },
